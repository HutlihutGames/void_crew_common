...
namespace VC.Common.Editor
{
    ...
    {
        [MenuItem("Void Crew/Tag table")]
        static void Init()
        {
            TagsWindow window = (TagsWindow)GetWindow(typeof(TagsWindow));
            window.name = "Tag table";
            window.Show();
        }
        ...
        private void CreateGUI()
        {
            ...
            {
                element.Q<TextField>("key").value = data[i];
            };
